...
BubbleTree.Styles.Funcao = {
	'28': { icon: 'government-uk.svg', color: '#C75746' },
	'1': { icon: 'legislative.svg' },
	'4': { icon: 'misc-services.svg', color: '#0AB971' },
	'6': { icon: 'order-safety.svg', color: '#EC2406' }, 
	'9': { icon: 'social-systems.svg', color: '#790586' }, 
	'05': { icon: 'environment.svg', color: '#2A3A03' },	
	'06': { icon: 'our-streets.svg', color: '#D33673' },		
	'10': { icon: 'health.svg', color: '#4E6D00' },											
	'08': { icon: 'culture.svg', color: '#938626' },					
	'12': { icon: 'education.svg' },			
	'10': { icon: 'helping-others.svg', color: '#935B3B' }	
}

BubbleTree.Styles.SubFuncao = {
